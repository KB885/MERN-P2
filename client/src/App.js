                  ...
                  <div>
                    <Menu.Button className="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                      ...
                      <img
                        ...
                        src="https://cdn.cloudflare.steamstatic.com/steamcommunity/public/images/avatars/d7/d7f695d4bc3250d8d7c450d889227b6ab33fdc63.jpg"
                        alt=""
                      />
                    </Menu.Button>
                  </div>
          ...
          <main>
            <div className="py-6">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                <h1 className="text-2xl font-semibold text-gray-900">shadow</h1>
              </div>
            </div>
          </main>
        </div>
